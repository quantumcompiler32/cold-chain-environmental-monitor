...
# Keep AI training inputs and generated artifacts together under ai_worker so
# a fresh checkout has one obvious place for model-related files.
DEFAULT_MODEL_DIR = Path(__file__).resolve().parent / "models"
DEFAULT_CSV = Path(__file__).resolve().parent / "data" / "Test1_TempCO2O2.csv"

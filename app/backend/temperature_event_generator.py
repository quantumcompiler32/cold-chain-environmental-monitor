...
# The repository ships a small sample; pass --csv-file to use the full local
# paper dataset. Its thermocouple values are F.
CSV_FILE = str(Path(__file__).resolve().parents[2] / "data" / "sample" / "Test1_TempCO2O2.csv")
DEFAULT_SENSOR = "Pod1"
...
def load_temperature_data(csv_path: Path, requested_sensor: str):
    ...
    if not csv_path.exists():
        raise FileNotFoundError(
            ...
            "Use --csv-file to point at the full local paper dataset or the bundled sample."
        )
